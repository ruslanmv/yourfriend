...
export function Header({ preference, onTheme }: { preference: ThemePreference; onTheme: (v: ThemePreference) => void }) {
  ...
  return <header className="site-header">
    ...
    <div className="header-actions">
      ...
      <a className="login-link" href={site.liveDemoUrl} target="_blank" rel="noopener noreferrer">Live demo</a>
      <a className="header-demo" href={site.repoUrl} target="_blank" rel="noopener noreferrer">GitHub <span aria-hidden="true">↗</span></a>
