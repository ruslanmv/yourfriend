  ...
  return <section className="hero" id="product">
    ...
    <div className="hero__content container">
      <div className="hero__copy">
        ...
        <div className="hero__actions"><Button onClick={onDemo} variant="primary">Request Demo <span aria-hidden="true">→</span></Button><Button onClick={onPreview} variant="secondary" icon="play">Watch Preview</Button></div>
